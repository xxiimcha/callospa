...
if (isset($_SESSION['username'])) {
  ...
  logActivity($username, "Accessed Amenities Dashboard Page");
}
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
      ...
      selectable: true,
      selectMirror: true,
      events: 'AmenitiesReservations.php', // Path to your PHP script
  ...
  <section id="content">
    <main>
      <div class="head-title">
        <div class="left">
          <h1>Amenities Reservation Dashboard</h1>
          <ul class="links">
            <li>
              <a class="active" href="AdministratorPage.php">Dashboard</a>
            </li>
            </li>
            <li><i class="bx bx-chevron-right"></i></li>
            <li>
              <a class="active" href="AmenitiesDashboard.php">Amenities Reservation Dashboard</a>
            <li>
            </li>
          </ul>
        </div>
