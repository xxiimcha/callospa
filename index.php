...
$navLinks = [
    "Home" => "Customer/HomePage.php",
    "Packages" => "Customer/PackagesPage.php",
    "Rooms" => "Customer/RoomsPage.php",
    "Events" => "Customer/EventsPage.php",
    "Spa" => "Customer/AmenitiesPage.php",
    "Gallery" => "Customer/GalleryPage.php",
];
