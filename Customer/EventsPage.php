...
$query = "SELECT event_type, description, event_images FROM events";
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        $first_image = !empty($images) ? trim($images[0]) : '';
...
<head>
    ...
    <title>Callospa Resort - List of Events</title>
</head>
...
<body>
    ...
    <main>
        <section class="section-hero section-hero--event">
        ...
        <section class="section">
            <div class="u-container">
                <div class="u-text-center u-margin-bottom-xl">
                    <h2 class="heading heading-secondary u-margin-bottom-md">Event Categories</h2>
                ...
                <div class="grid grid-3-cols">
                    <?php foreach ($eventCategories as $category): ?>
                        <article class="card">
                            <img src="<?php echo htmlspecialchars($category['images'], ENT_QUOTES, 'UTF-8'); ?>" alt="<?php echo htmlspecialchars($category['event_type'], ENT_QUOTES, 'UTF-8'); ?>" class="card-img" />
                            <div class="card-body">
                                <h3 class="card-title"><?php echo htmlspecialchars($category['event_type'], ENT_QUOTES, 'UTF-8'); ?></h3>
                                <p class="card-desc"><?php echo htmlspecialchars($category['description'], ENT_QUOTES, 'UTF-8'); ?></p>
                                <a href="EventReservationForm.php" class="card-btn">Book Now</a>
                            </div>
                        </article>
                    <?php endforeach; ?>
                </div>
