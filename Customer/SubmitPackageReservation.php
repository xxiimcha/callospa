...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($first_name) || empty($last_name) || empty($contact_number) || empty($email) || empty($package) || empty($check_in_date) || empty($check_out_date) || empty($guests) || empty($payment_method)) {
...
?>
        ...
        <body>
                        ...
                        <nav class="nav">
                            <ul class="nav-list">
                                ...
                                foreach ($navLinks as $name => $link):
                                    $isActive = (basename($link) == $currentPage || ($currentPage == 'SubmitPackageReservation.php' && basename($link) == 'PackagesPage.php')) ? 'active' : '';
                                ?>
                                    <li class="nav-item">
            ...
            <main>
                <section class="section-hero section-hero--submit-package">
                ...
                <div class="reservation">
                    ...
                    <div class="reservation-body">
                        ...
                        <div class="reservation-info">
                            ...
                            <ul class="reservation-list">
                                <li class="reservation-item">
                                    <span class="reservation-label">Package</span>
