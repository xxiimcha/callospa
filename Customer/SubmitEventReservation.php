...
?>
        ...
        <body>
                        ...
                        <nav class="nav">
                            <ul class="nav-list">
                                ...
                                foreach ($navLinks as $name => $link):
                                    $isActive = (basename($link) == $currentPage || ($currentPage == 'SubmitEventReservation.php' && basename($link) == 'EventsPage.php')) ? 'active' : '';
                                ?>
                                    <li class="nav-item">
            ...
            <main>
                <section class="section-hero section-hero--submit-event">
                ...
                <div class="reservation">
                    ...
                    <div class="reservation-body">
                        ...
                        <div class="reservation-info">
                            ...
                            <ul class="reservation-list">
                                <li class="reservation-item">
                                    <span class="reservation-label">Event Venue</span>
                                    <span class="reservation-data"><?php echo htmlspecialchars($package_category, ENT_QUOTES, 'UTF-8'); ?></span>
                                </li>
                                <li class="reservation-item">
                                    <span class="reservation-label">Event Package</span>
                                    <span class="reservation-data"><?php echo htmlspecialchars($package, ENT_QUOTES, 'UTF-8'); ?></span>
                                </li>
                                <li class="reservation-item">
                                    <span class="reservation-label">Event Type</span>
                                    <span class="reservation-data"><?php echo htmlspecialchars($event_type, ENT_QUOTES, 'UTF-8'); ?></span>
                                </li>
                                <li class="reservation-item">
                                ...
                                <li class="reservation-item">
                                    <span class="reservation-label">Catering Preference</span>
                                    <span class="reservation-data"><?php echo htmlspecialchars($catering_preference, ENT_QUOTES, 'UTF-8'); ?></span>
                                </li>
                            </ul>
                        </div>
